pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://13.223.49.239:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/jairajreddy/fullstack-207-practical-3.git', branch: 'main'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://13.223.49.239:9090/springapp1"
            echo "✅ Frontend deployed: http://13.223.49.239:9090/frontapp1"
        }
        failure {
